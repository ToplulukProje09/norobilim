...
export default function BlogList() {
  ...
  if (blogs.length === 0)
    return (
      <div className="flex flex-col min-h-screen items-center justify-center space-y-4 p-4 text-center">
  ...
  // Filtreleme sonucunda blog yoksa bu mesajı göster
        ...
        {filteredBlogs.map((b) => (
          ...
          >
            ...
            <CardHeader className="flex-grow pb-0">
              <CardTitle className="line-clamp-2 text-lg">{b.title}</CardTitle>
                ...
                >
                  ...
                  <div className="flex-grow overflow-y-auto px-6 py-4">
                    <div className="space-y-6">
                      ...
                      {b.paragraph && (
                        <div className="border-t pt-4">
                          <p className="font-semibold text-sm">İçerik Metni:</p>
                          <p className="mt-1 text-sm text-muted-foreground text-wrap break-words">
                            {b.paragraph}
                          </p>
                        </div>
